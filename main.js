...
//! Icon ile side-bar açıp kapama

document.addEventListener("DOMContentLoaded", function () {
  let openButton = document.getElementById("open"); // Açma ikonu
  let closeButton = document.getElementById("close"); // Kapama ikonu
  let sidebar = document.getElementById("sidebar"); // Sidebar elementi

  closeButton.style.display = "none"; // Kapama ikonunu başlangıçta gizle

  // Açma ikonuna tıklama olayı
  openButton.addEventListener("click", function () {
    sidebar.style.display = "block"; // Sidebar'ı göster
    openButton.style.display = "none"; // Açma ikonunu gizle
    closeButton.style.display = "block"; // Kapama ikonunu göster
  });

  // Kapama ikonuna tıklama olayı
  closeButton.addEventListener("click", function () {
    sidebar.style.display = "none"; // Sidebar'ı gizle
    closeButton.style.display = "none"; // Kapama ikonunu gizle
    openButton.style.display = "block"; // Açma ikonunu göster
  });
});
